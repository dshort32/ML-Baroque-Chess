#!/usr/bin/python3
'''Milestone_A_aaronbae_Baroque_Chess.py
...
aaron = Partner("Bae", "Beomjun Aaron", "aaronbae")
daniel = Partner("Short", "Daniel", "dshort32")
team = [aaron, daniel]
...
workload_distribution = '''Aaron will have primary responsibility for the
static evaluation function, Daniel will have primary responsibility for
...
our_submission = Who_and_what([aaron, daniel], OPTION, title, approach, workload_distribution, [reference1, reference2])
